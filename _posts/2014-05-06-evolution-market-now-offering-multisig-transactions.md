...
<p>We have another market joining the Munmltisig Family, Now evolution, as always, we try to support those market offering multisig transaction so we bring you here the multisig usage guide as its listed on their wiki, this will also be listed on out <a href="multisig-guides/">multisig guides</a> page and the market will be promoted to the multisig category <a href="/2013/10/28/updated-llist-of-hidden-marketplaces-tor-i2p/">on our list</a>:</p>
